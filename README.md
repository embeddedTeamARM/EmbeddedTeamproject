...
## 0. 프로젝트 소개   
   ...
   사용자는 블루투스로 예약시간 및 조명 밝기를 설정하여, 해당 시간동안은 설정한 밝기로 조명을 조절할 수 있다. 또한 실시간으로 조절하길 원하는 경우, 수동으로 원하는 밝기를 조절할 수 있다. 시스템은 사용자에게 남은 예약시간을 표시해주고, 예약 시간 종료 후에는 조명이 다시 원래의 최대 밝기로 돌아오게 된다. 
